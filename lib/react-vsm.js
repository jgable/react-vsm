...
class VisualStateStyleAnimation extends VisualStateAnimation {
  animate() {
    return new Promise(function (resolve) {
      var target = this.getDOMTarget();
      Velocity(target, this.getAnimationProperties(), {
  ...
  getAnimationProperties() {
    throw new Error('Must implement getAnimationProperties()');
  }
}

class BackgroundColorAnimation extends VisualStateStyleAnimation {
  getAnimationProperties() {
    return { backgroundColor: this.props.to };
  }
}
